...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { job_id: @requirement.job_id, requirement: @requirement.requirement } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { job_id: @requirement.job_id, requirement: @requirement.requirement } }
